...
// can be mutated and processed asynchronously before it is committed a€¡± a form
...
function enqueueUpdate(fiber, update, expirationTime) {
  ...
  if (queue2 === null || queue1 === queue2) {
    ...
    // while accounting for the persistent structure of the list a€¡± we don't
...
/**
 * The "base" render time is the duration of the a€?begina€? phase of work for a particular fiber.
